...
class ResNet_spd(nn.Module):
    ...
    def _make_layer(self, block, out_channels, num_blocks, mystride):
        ...
        strides = [mystride] + [1] * (num_blocks - 1)
        layers = []
        for mystride in strides:
            layers.append(block(self.in_channels, out_channels, mystride))
